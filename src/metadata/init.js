...
/**
* ### Справочник ПунктыПриемаОтгрузки
* Пункты приема отгрузки
* @class CatPunkt
* @extends CatObj
* @constructor 
*/
class CatPunkt extends CatObj{
get users(){return this._getter('users')}
set users(v){this._setter('users',v)}
get predefined_name(){return this._getter('predefined_name')}
set predefined_name(v){this._setter('predefined_name',v)}
}
$p.CatPunkt = CatPunkt;
...
/**
* ### Документ АктСдачиПриемаДревесины
* Акт сдачи приема древесины
* @class DocAct_wood
* @extends DocObj
* @constructor 
*/
class DocAct_wood extends DocObj{
get responsible(){return this._getter('responsible')}
set responsible(v){this._setter('responsible',v)}
get ПунктПриемаОтгрузки(){return this._getter('ПунктПриемаОтгрузки')}
set ПунктПриемаОтгрузки(v){this._setter('ПунктПриемаОтгрузки',v)}
}
$p.DocAct_wood = DocAct_wood;
$p.doc.create('act_wood');

/**
* ### Документ ОтчетОПринятойОтгруженнойДревесине
* Отчет о принятой отгруженной древесине
* @class DocReport_wood
* @extends DocObj
* @constructor 
*/
class DocReport_wood extends DocObj{
get responsible(){return this._getter('responsible')}
set responsible(v){this._setter('responsible',v)}
get ПунктПриемаОтгрузки(){return this._getter('ПунктПриемаОтгрузки')}
set ПунктПриемаОтгрузки(v){this._setter('ПунктПриемаОтгрузки',v)}
}
$p.DocReport_wood = DocReport_wood;
$p.doc.create('report_wood');
